...
\begin{footnotesize}
  \begin{longtabu} to \linewidth { |l|l|X[2]|p{1.2cm}|p{1.2cm}|X| }
    \hline
    Version & Datum & Anmärkning & Första läsning & Ev. andra läsning & Ansvarig \\ \hline
    2.0 & YYYY-MM-DD & Antagna av sektionsmötet enligt XXXXXX & 21-03-08 & 21-04-11 & Sektionsmötet, Vilhelm Melkstam \\ \hline
  \end{longtabu}
\end{footnotesize}
