...
\begin{footnotesize}
  \begin{longtabu} to \linewidth { |l|l|X[2]|p{1.6cm}|X| }
    \hline
    Version & Datum & Anmärkning & Antagna på sektionsmöte & Ansvarig \\ \hline
    2.0 & YYYY-MM-DD & Antagna av sektionsmötet enligt XXXXXX & 21-MM-DD & Sektionsmötet, Vilhelm Melkstam \\ \hline
  \end{longtabu}
\end{footnotesize}
...
\begin{itemize}
  ...
  \item Sektionens bronsmedalj utdelas av sektionsmötet för ett fullgjort förtroendeuppdrag.
