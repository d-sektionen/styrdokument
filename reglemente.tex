...
\begin{tblr}{|Q[l]|Q[l]|} \hline
  ...
  2021-04-11 & Antagna av sektionsmötet enligt ``Proposition angående revidering av styrdokument'' \\ \hline
  2021-10-10 & Reviderat enligt ``Motion angående att strukturera om Aktivitetsutskottets ledning'' \\ \hline
  2023-05-02 & Reviderat enligt ``Motion angående uppdatering av reglemente kring ekonomisk verksamhet'' \\ \hline
  2023-12-06 & Reviderat enligt ``Proposition angående revidering av styrdokument'' \\ \hline
  2025-01-17 & Reviderat enligt ``Proposition angående sektionens jubileum'' \\ \hline
  2025-01-17 & Reviderat enligt ``Motion angående sektionsloggor'' \\ \hline
  2025-06-32 & Reviderat enligt ``Motion angående ändring av tidpunkt för inval Valberedningens Ordförande'' \\ \hline
  2026-03-03 & Reviderat enligt ``Proposition angående förvaltande av dokumentation kring
högtidlighållanden
'' \\ \hline
2026-03-03 & Reviderat enligt ``Proposition angående tillägg av policydokument'' \\ \hline
...
\begin{itemize}
  ...
  \item Policy kring inlämning av bokföringsunderlag
\item Policy kring interna äskningar
  \item Policy kring självrisker och böter
\end{itemize}
...
\begin{itemize}
  ...
  \item Eventutskottets ordförande
  \item 1-2 Ledamöter
\end{itemize}
...
\begin{itemize}
  ...
  \item Jubileumsgeneral inför verksamhetsår då sektionen ska högtidlighållas enligt \S \ref{hogtidshallande}.
  \item Jubileumskassör inför verksamhetsår då sektionen ska högtidlighållas enligt \S \ref{hogtidshallande}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Revisorer
  \item Valberedningens ledamöter
\end{itemize}
...
\subsection{Jubileumsutskottet}
Jubileumsutskottet ansvarar för att fira sektionens bildande. Det åligger sektionsstyrelsen att säkerställa att dokumentation och relevant information kring
sektionens jubileumsfiranden bevaras och överlämnas mellan verksamhetsår.


Jubileumsgeneralen agerar ordförande.
...
Sektionen har en bil som används till sektionsarbete och lånas ut till sektionens medlemmar samt
utomstående. Bilen bokas via bokningssystemet på sektionens webbplats.
...
av en framlagd och godkänd budget från jubileumskassören till beslutsfattande organ. Det
åligger sektionsstyrelsen att aktivt informera jubileumskassören om fondens existens och
...
\subsubsection{Utskottens logotyper}
Samtliga logotyper på Datateknologsektionen ska vara uppdaterade i enlighet med den grafiska
profilen. 

Undantag kan beviljas av Infoutskottet och kan göras av historiska skäl, PR-skäl, eller då det
finns ett tydligt syfte som gynnar utskottets verksamhet.
Vid byte av ett utskotts logotyp ska logotypen godkännas av Infoutskottet. Detta görs via ett inskick av
loggan samt en skriftlig motivering till Infoutskottet.
