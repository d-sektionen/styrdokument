...
\begin{document}
  ...
  \section{Medlemskap}
    ...
    \subsection{Studerandemedlem}
      ...
      \begin{itemize}
        ...
        utbildningsprogram som sektionen representerar (se § \ref{utbildningsprogram})
    ...
    \subsection{Hedersmedlem}
      ...
      sektionsmötet. (Se vidare § \ref{medaljer})
  ...
  \section{Sektionsmöte}
    ...
    \subsection{Deltagarnas rättigheter}
      ...
      studerandemedlem (Se §\ref{medlemskap}). Närvaro-, yttrande- och förslagsrätt tillkommer varje annan
    ...
    \subsection{Omröstning}
      ...
      Justeringspersonerna agerar rösträknare vid omröstning. (se § \ref{justeringavprotokoll})
    ...
    \subsection{Vårmötet}
      ...
      \begin{itemize}
        ...
        \item Varje udda år fastställa Arbetsmarknadsgruppens budget
    ...
    \subsection{Höstmötet}
      ...
      \begin{itemize}
        ...
        \item Behandla sektionens verksamhetsberättelse för föregående år
        \item Behandla föregående årsrevisionsberättelse för fadderiet
        \item Behandla föregående årsrevisionsberättelse för damföreningen
        \item Varje udda år behandla föregående verksamhetsberättelse för Arbetsmarknadsgruppen
        \item Varje udda år behandla föregående årsrevisionsberättelse för Arbetsmarknadsgruppen
        \item Behandla sektionens och festeriets årsrevisionsberättelse för föregående verksamhetsår
        \item Besluta om ansvarsfrihet för föregående års fadderi, festeri, damförening och styrelse
        \item Varje jämnt år besluta om ansvarsfrihet för föregående års Arbetsmarknadsgruppen
      \end{itemize}
  ...
  \section{Sektionsstyrelsen}
    ...
    \subsection{Presidium}
      ...
      §\ref{ekonomisektionen}. Presidiet består av styrelsens ordförande och kassör.
  ...
  \section{Revision}
    ...
    \subsection{Rättigheter}
      Revisorerna har rätt att närvara vid styrelsemötena (se § \ref{sektionsstyrelsensammantrade}). Revisorerna har tillträde till
