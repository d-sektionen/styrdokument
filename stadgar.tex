...
\begin{footnotesize}
  ...
  26-03-03 & Reviderat enligt ``Proposition angående sektionskassörens åligganden''.  \\ \hline
   \end{tblr}
\end{footnotesize}
...
\begin{itemize}
  ...
  \item ansvara för att inventarie-/lagerföra sektionens tillgångar genomförs
